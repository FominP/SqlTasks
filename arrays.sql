/*
1. Найдите сессии с ровно 3 добавлениями в корзину - 1 балл
Используя таблицу array_tasks.user_activity в БД postgres напишите запрос, который найдет всех пользователей, которые добавили товар в корзину (add_to_cart) равно 3 раза. Верните уникальные идентификаторы таких пользователей и сессии, в которых произошло данное событие.
*/
...
/*
2. Конверсия из просмотра в покупку - 2 балла
